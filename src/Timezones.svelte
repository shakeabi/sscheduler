...
<select name="timezone_offset" id="timezone-offset" bind:value={timezone}>
	...
	<option value="-0930">(GMT -9:30) Taiohae</option>
	...
	<option value="-0430">(GMT -4:30) Caracas</option>
	...
	<option value="+0530" selected="selected">(GMT +5:30) Bombay, Calcutta, Madras, New Delhi</option>
	<option value="+0545">(GMT +5:45) Kathmandu, Pokhara</option>
	<option value="+0600">(GMT +6:00) Almaty, Dhaka, Colombo</option>
	<option value="+0630">(GMT +6:30) Yangon, Mandalay</option>
	...
	<option value="+0845">(GMT +8:45) Eucla</option>
	...
	<option value="+1030">(GMT +10:30) Lord Howe Island</option>
	<option value="+1100">(GMT +11:00) Magadan, Solomon Islands, New Caledonia</option>
	<option value="+1130">(GMT +11:30) Norfolk Island</option>
